...
public class Friday extends AppCompatActivity implements AdapterView.OnItemSelectedListener,TimeTable{
    ...
    private static final int NOTIFICATION_ID2 =1234;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder buildIt = new AlertDialog.Builder(Friday.this);
    ...
    public void tableItemRemover(){
        ...
        timeTable.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder build = new AlertDialog.Builder(Friday.this);
    ...
    public void savingTimeTable(){
        ...
        editor.putInt("course_time_table_fri",list.size());

        for(int i=0;i<list.size();i++){
            editor.remove("course_time_table_fri" + i);
            editor.putString("course_time_table_fri"+i,list.get(i));
        }
        editor.apply();
    }
    ...
    public void loadingTimeTableHere(Context context){
        ...
        list.clear();
        int size = savedContentLoadTimeTable.getInt("course_time_table_fri",0);

        for(int i=0;i<size;i++){
            list.add(savedContentLoadTimeTable.getString("course_time_table_fri" +i,null));
            Log.d("Sharing",savedContentLoadTimeTable.getString("course_time_table_fri" +i,null));
        }
    }
    ...
    public void savingNotes(){
        ...
        editor.putString("save_note_fri",note);
        editor.putString("note_time_fri",noteTime);
        editor.apply();
    ...
    public void loadNotes(Button button){
        SharedPreferences savedNote = PreferenceManager.getDefaultSharedPreferences(this);
        String note =savedNote.getString("save_note_fri",null);
        editNote.setText(note);
        if(editNote.getText().toString().isEmpty()){
            button.setText(R.string.pick_a_time);
        }else{
            button.setText(savedNote.getString("note_time_fri",null));
        }
    }
