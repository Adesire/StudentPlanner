...
public class Thursday extends AppCompatActivity implements AdapterView.OnItemSelectedListener,TimeTable {
    ...
    private static final int NOTIFICATION_ID2 =1233;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder buildIt = new AlertDialog.Builder(Thursday.this);
    ...
    public void tableItemRemover(){
        ...
        timeTable.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder build = new AlertDialog.Builder(Thursday.this);
    ...
    public void savingTimeTable(){
        ...
        editor.putInt("course_time_table_thu",list.size());

        for(int i=0;i<list.size();i++){
            editor.remove("course_time_table_thu" + i);
            editor.putString("course_time_table_thu"+i,list.get(i));
        }
        editor.apply();
    }
    ...
    public void loadingTimeTableHere(Context context){
        ...
        list.clear();
        int size = savedContentLoadTimeTable.getInt("course_time_table_thu",0);

        for(int i=0;i<size;i++){
            list.add(savedContentLoadTimeTable.getString("course_time_table_thu" +i,null));
            Log.d("Sharing",savedContentLoadTimeTable.getString("course_time_table_thu" +i,null));
        }
    }
    ...
    public void savingNotes(){
        ...
        editor.putString("save_note_thu",note);
        editor.putString("note_time_thu",noteTime);
        editor.apply();
    ...
    public void loadNotes(Button button){
        SharedPreferences savedNote = PreferenceManager.getDefaultSharedPreferences(this);
        String note =savedNote.getString("save_note_thu",null);
        editNote.setText(note);
        if(editNote.getText().toString().isEmpty()){
            button.setText(R.string.pick_a_time);
        }else{
            button.setText(savedNote.getString("note_time_thu",null));
        }
    }
    ...
    public Notification getNotification(String content) {
        PendingIntent contentPendingIntent = PendingIntent.getActivity(this,0,new Intent(this,Monday.class),PendingIntent.FLAG_UPDATE_CURRENT);
