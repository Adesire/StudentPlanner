...
public class Monday extends AppCompatActivity implements AdapterView.OnItemSelectedListener,TimeTable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder buildIt = new AlertDialog.Builder(Monday.this);
    ...
    public void tableItemRemover(){
        ...
        timeTable.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder build = new AlertDialog.Builder(Monday.this);
    ...
    public void savingTimeTable(){
        ...
        editor.putInt("course_time_table",list.size());

        for(int i=0;i<list.size();i++){
            editor.remove("course_time_table" + i);
            editor.putString("course_time_table"+i,list.get(i));
        }
        editor.apply();
    }
    ...
    public void loadingTimeTableHere(Context context){
        ...
        list.clear();
        int size = savedContentLoadTimeTable.getInt("course_time_table",0);

        for(int i=0;i<size;i++){
            list.add(savedContentLoadTimeTable.getString("course_time_table" +i,null));
            Log.d("Sharing",savedContentLoadTimeTable.getString("course_time_table" +i,null));
        }
    }
    ...
    public void savingNotes(){
        ...
        editor.putString("save_note",note);
        editor.putString("note_time",noteTime);
        editor.apply();
    ...
    public void loadNotes(Button button){
        SharedPreferences savedNote = PreferenceManager.getDefaultSharedPreferences(this);
        String note =savedNote.getString("save_note",null);
        editNote.setText(note);
        if(editNote.getText().toString().isEmpty()){
            button.setText(R.string.pick_a_time);
        }else{
            button.setText(savedNote.getString("note_time",null));
        }
    }
